...
CFLAGS		:= $(FALSE_POSITIVES) -DNDEBUG -DLIBOGC_INTERNAL -g -O2 -fno-strict-aliasing -Wall $(MACHDEP) $(INCLUDES)
...
OGCOBJ		:=	\
			...
			video_asm.o video.o pad.o dvd.o dvdlight.o exi.o mutex.o arqueue.o	arqmgr.o	\
